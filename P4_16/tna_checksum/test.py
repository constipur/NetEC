...
class Ipv4ChksumTest(BfRuntimeTest):
    ...
    def runTest(self):
        ...
        try:
            ...
            testutils.send_packet(self, swports[0], str(ipkt))
...
class Ipv4TranslateNoUpdTest(BfRuntimeTest):
    ...
    def runTest(self):
        ...
        action_data = table_translate.make_data(
            ...
            data_field_list_in=[
                gc.DataTuple(name="src_addr", val=self.ipv4_to_bytes("4.3.2.1")),
...
class TcpTranslateNoUpdTest(BfRuntimeTest):
    ...
    def runTest(self):
        ...
        action_data = table_translate.make_data(
            ...
            data_field_list_in=[
                gc.DataTuple(name="src_port", val=self.to_bytes(0x4321, 2)),
                gc.DataTuple(name="update", val=0x0)
            ],
        )
